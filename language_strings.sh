...
function language_strings() {
	...
	arr["ENGLISH",35]="Deauthentication / Dissasociation mdk4 attack chosen (monitor mode needed)"
	arr["SPANISH",35]="Elegido ataque de Desautenticación / Desasociación mdk4 (modo monitor requerido)"
	arr["FRENCH",35]="L'attaque de Dés-authentification / Dissociation mdk4 a été choisie (mode moniteur nécessaire)"
	arr["CATALAN",35]="Seleccionat atac de Desautenticació / Dissociació mdk4 (es requereix mode monitor)"
	arr["PORTUGUESE",35]="Ataque de desautenticação com mdk4 (modo monitor obrigatório)"
	arr["RUSSIAN",35]="Выбрана mdk4 атака Деаутентификации / Разъединения (необходим режим монитора)"
	arr["GREEK",35]="Deauthentication / Έχει επιλεχθεί επίθεση dissasociation mdk4 (χρειάζεται η κατάσταση παρακολούθησης)"
	arr["ITALIAN",35]="Attacco Deauth / Disassociation mdk4 scelto (modalità monitor richiesta)"
	arr["POLISH",35]="Wybrano atak Deauthentication / Disassociation mdk4 (wymagany tryb monitorowania)"
	arr["GERMAN",35]="Deauthentication / Disassociation mdk4 Angriff ausgewählt (monitor-Modus erforderlich)"
	arr["TURKISH",35]="Deauthentication / Dissasociation mdk4 saldırısı seçildi (izleme modu gereklidir)"
	...
	arr["ENGLISH",51]="5.  Deauth / disassoc amok mdk4 attack"
	arr["SPANISH",51]="5.  Ataque Deauth / Disassoc amok mdk4"
	arr["FRENCH",51]="5.  Attaque Deauth / Disassoc amok mdk4"
	arr["CATALAN",51]="5.  Atac Deauth / Disassoc amok mdk4"
	arr["PORTUGUESE",51]="5.  Ataque Deauth / Disassoc amok mdk4"
	arr["RUSSIAN",51]="5.  Атака деаутентификации / разъединения amok mdk4"
	arr["GREEK",51]="5.  Επίθεση Deauth / Disassoc amok mdk4"
	arr["ITALIAN",51]="5.  Attacco Deauth / Disassoc amok mdk4"
	arr["POLISH",51]="5.  Atak Deauth / Disassoc amok mdk4"
	arr["GERMAN",51]="5.  Deauth / Disassoc Amok mdk4 Angriff"
	arr["TURKISH",51]="5.  Deauth / disassoc amok mdk4 saldırısı"
	...
	arr["ENGLISH",89]="Mdk4 amok action"
	arr["SPANISH",89]="Acción mdk4 amok"
	arr["FRENCH",89]="Action mdk4 amok"
	arr["CATALAN",89]="Acció mdk4 amok"
	arr["PORTUGUESE",89]="Ação mdk4 amok"
	arr["RUSSIAN",89]="Mdk4 amok в действии"
	arr["GREEK",89]="Ενέργεια mdk4 amok"
	arr["ITALIAN",89]="Azione mdk4 amok"
	arr["POLISH",89]="Akcja mdk4 amok"
	arr["GERMAN",89]="mdk4 amok Aktion"
	arr["TURKISH",89]="Mdk4 amok etkisi"
	...
	arr["ENGLISH",95]="Mdk4 amok parameters"
	arr["SPANISH",95]="Parámetros Mdk4 amok"
	arr["FRENCH",95]="Paramètres Mdk4 amok"
	arr["CATALAN",95]="Paràmetres Mdk4 amok"
	arr["PORTUGUESE",95]="Parâmetros Mdk4 amok"
	arr["RUSSIAN",95]="Параметры Mdk4 amok"
	arr["GREEK",95]="Παράμετροι Mdk4 amok"
	arr["ITALIAN",95]="Parametri Mdk4 amok"
	arr["POLISH",95]="Parametry Mdk4 amok"
	arr["GERMAN",95]="Mdk4 amok Parameter"
	arr["TURKISH",95]="Mdk4 amok parametreleri"
	...
	arr["ENGLISH",139]="1.  Deauth / disassoc amok mdk4 attack"
	arr["SPANISH",139]="1.  Ataque Deauth / Disassoc amok mdk4"
	arr["FRENCH",139]="1.  Attaque Deauth / Disassoc amok mdk4"
	arr["CATALAN",139]="1.  Atac Deauth / Disassoc amok mdk4"
	arr["PORTUGUESE",139]="1.  Ataque Deauth / Disassoc amok mdk4"
	arr["RUSSIAN",139]="1.  Атака деаутентификации / разъединения amok mdk4"
	arr["GREEK",139]="1.  Επίθεση Deauth / disassoc amok mdk4"
	arr["ITALIAN",139]="1.  Attacco Deauth / Disassoc amok mdk4"
	arr["POLISH",139]="1.  Atak Deauth / Disassoc amok mdk4"
	arr["GERMAN",139]="1.  Deauth / Disassoc Amok mdk4 Angriff"
	arr["TURKISH",139]="1.  Deauth / disassoc amok mdk4 saldırısı"
	...
	arr["ENGLISH",260]="5.  Smooth mode Enterprise Evil Twin"
	arr["SPANISH",260]="5.  Evil Twin Enterprise modo smooth"
	arr["FRENCH",260]="5.  Evil Twin Enterprise mode silencieux"
	arr["CATALAN",260]="5.  Evil Twin Enterprise mode smooth"
	arr["PORTUGUESE",260]="5.  Evil Twin Enterprise (discreto)"
	arr["RUSSIAN",260]="5.  Smooth режим Enterprise Evil Twin"
	...
	arr["ENGLISH",307]="6.  Noisy mode Enterprise Evil Twin"
	arr["SPANISH",307]="6.  Evil Twin Enterprise modo noisy"
	arr["FRENCH",307]="6.  Evil Twin Enterprise mode bruyant"
	arr["CATALAN",307]="6.  Evil Twin Enterprise mode noisy"
	arr["PORTUGUESE",307]="6.  Evil Twin Enterprise (agressivo)"
	arr["RUSSIAN",307]="6.  Noisy режим Enterprise Evil Twin"
	...
	arr["TURKISH",329]="Görünüşe göre ${optional_tools_names[12]} var. Yazılım devam edebilir..."
	...
	arr["FRENCH",590]="Vous pouvez modifier manuellement le fichier ${rc_file} qui se trouve dans le même dépôt que le script pour modifier ses options. Vous pouvez également lancer \"flags\" sur la ligne de commande. Plus d'information sur: ${urlgithub_wiki}/Options"
	arr["CATALAN",590]="Pots modificar manualment el fitxer ${rc_file} que està en el mateix directori que l'script per modificar les seves opcions. També pots llançar \"flags\" a la línia d'ordres. Més informació a: ${urlgithub_wiki}/Options"
	arr["PORTUGUESE",590]="Você pode modificar manualmente o arquivo ${rc_file} que está no mesmo diretório do script. Você também pode usar argumentos ao executar airgeddon na linha de comando. Mais informações sobre: ${urlgithub_wiki}/Options"
	...
	arr["GREEK",590]="Μπορείτε να τροποποιήσετε χειροκίνητα το αρχείο ${rc_file} που βρίσκεται στον ίδιο κατάλογο με το script για να αλλάξετε ρυθμίσεις. Μπορείτε επίσης να βάλετε \"flags\" στη γραμμή εντολών. Περισσότερες πληροφορίες σχετικά αυτό: ${urlgithub_wiki}/Options"
	...
	arr["FRENCH",591]="La modification de ces options modifie le fichier ${rc_file} et les modifications sont permanentes"
	arr["CATALAN",591]="Canviant aquestes opcions modifiqueu el fitxer ${rc_file} i els canvis són permanents"
	arr["PORTUGUESE",591]="As modificações no arquivo ${rc_file} são permanentes"
	arr["RUSSIAN",591]="Изменение этих параметров меняет файл ${rc_file}, и эти настройки становятся постоянными"
	arr["GREEK",591]="Η αλλαγή αυτών των ρυθμίσεων τροποποιεί το αρχείο ${rc_file} και οι αλλαγές είναι μόνιμες"
	...
	arr["TURKISH",591]="Bu seçenekleri değiştirmek, ${rc_file} dosyasını değiştirir ve değişiklikler kalıcıdır"
	...
	arr["CATALAN",613]="Atencio. Comprova el fitxer de ${rc_file}. Valor no vàlid a la variable ${normal_color}${error_var_name}${yellow_color}. S'utilitzarà el valor predeterminat ${normal_color}${error_var_default_value}${yellow_color}"
	arr["PORTUGUESE",613]="Aviso: Por favor, verifique o arquivo ${rc_file} ou os argumentos na linha de comando. Valor inválido na variável ${normal_color}${error_var_name}${yellow_color}. O valor padrão ${normal_color}${error_var_default_value}${yellow_color} será usado"
	...
	arr["FRENCH",614]="Attention. Veuillez vérifier le fichier ${rc_file}. La variable de configuration ${normal_color}${error_var_name}${yellow_color} introuvable. ${normal_color}${error_var_default_value}${yellow_color} sera utilisé"
	arr["CATALAN",614]="Atencio. Si us plau, comprova el fitxer ${rc_file}. No s'ha trobat la variable de configuració ${normal_color}${error_var_name}${yellow_color}. S'utilitzarà ${normal_color}${error_var_default_value}${yellow_color}"
	arr["PORTUGUESE",614]="Aviso: Por favor, verifique o arquivo ${rc_file}. Variável de configuração ${normal_color}${error_var_name}${yellow_color} não encontrada. ${normal_color}${error_var_default_value}${yellow_color} será usado"
